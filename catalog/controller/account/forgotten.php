...
class ControllerAccountForgotten extends Controller {
	...
	public function mini() {
		...
		$data['action'] = $this->url->link('account/forgotten/mini', '', true);

		$data['back'] = $this->url->link('account/login/mini', '', true);
		...
		$json['template']=$this->load->view('account/forgotten_mini', $data);
