...
class ControllerProductManufacturer extends Controller {
	public function index() {
		...
		foreach ($results as $result) {
            ...
            */
            ...
            if ($result['image']) {
                $image = $this->model_tool_image->resize($result['image'], 207, 116);
            } else {
                $image = $this->model_tool_image->resize('placeholder.png', 207, 116);
            }
	...
	public function info() {
		...
		$manufacturer_info = $this->model_catalog_manufacturer->getManufacturerByCategory($manufacturer_id);

		if ($manufacturer_info) {
            $this->response->redirect($this->url->link('product/category', 'path=' . $manufacturer_info['category_id'], true));
    ...
    public function get() {
        ...
        foreach ($results as $result) {
            if ($result['image']) {
                $image = $this->model_tool_image->resize($result['image'], 150, 84);
            } else {
        ...
        $this->response->setOutput($this->load->view('common/menu_manufacturer_list', $data));
    }
}
