...
class ControllerBlogLatest extends Controller {
	public function index() {
		...
		*/
		...
		$category_info = $this->model_blog_category->getCategory(49);
		...
		*/
        ...
        $image_w    = $this->config->get('configblog_image_article_width');
        $image_h    = $this->config->get('configblog_image_article_height');
