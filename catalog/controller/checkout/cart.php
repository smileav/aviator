...
class ControllerCheckoutCart extends Controller {
		...
		if ($product_info) {
			...
			if (!$json) {
                if (isset($this->request->get['quick'])) {
                    if (!$this->cart->getProduct($this->request->post['product_id'], $option)) {
                ...
                if (isset($this->request->get['kit'])) {
                    $json['success'] = sprintf($this->language->get('text_kit_success'), $this->url->link('checkout/checkout'));
                } else {
                ...
                if (isset($this->request->get['kit'])) {
                    $json['error']['product_id'] = $product_id;
                } else {
    ...
    public function modal_size() {
        // $this->load->language('checkout/quick_order');

        $data = [];

        $this->response->setOutput($this->load->view('checkout/modal_size', $data));
    }
