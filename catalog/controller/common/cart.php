	...
	public function index() {
		...
		foreach ($this->cart->getProducts() as $product) {
            if ($product['image']) {
                ...
                $image = $this->model_tool_image->resize($product['image'], $image_w, $image_h, 'auto');
			} else {
            ...
            $total_custom += $this->tax->calculate($product['price'], $product['tax_class_id'], $this->config->get('config_tax')) * $product['quantity'];
		}

        $data['total_custom'] = $this->currency->format($total_custom, $this->session->data['currency']);
