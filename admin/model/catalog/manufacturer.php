...
class ModelCatalogManufacturer extends Model {
	...
	public function editManufacturer($manufacturer_id, $data) {
		...
		foreach ($data['manufacturer_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer_description SET manufacturer_id = '" . (int)$manufacturer_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($data['name']) . "', description = '" . $this->db->escape($value['description']) . "', meta_title = '" . $this->db->escape($value['meta_title']) . "', meta_h1 = '" . $this->db->escape($value['meta_h1']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "'");
		}
    ...
    public function getCategoryByManufacturerId($manufacturer_id) {
        $query = $this->db->query("SELECT `category_id` FROM `" . DB_PREFIX . "category` WHERE `manufacturer_id` = '" . (int)$manufacturer_id . "'");
    ...
    public function updateProductCategory($manufacturer_id, $category_id) {
