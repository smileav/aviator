	...
	class ControllerSeoLangMovaMova extends Controller {
		...
		public function install_ocmod_settings($this_data) {
			...
			if (!isset($this->data['seolang_settings']['mova_equal'])) {
				$this->data['seolang_settings']['mova_equal'] = true;
			}
        ...
        */
		...
		public function load_language($this_data) {
			...
			$this->data['entry_seolang_mova_widget_box_begin'] = $this->language->get('entry_seolang_mova_widget_box_begin');
			$this->data['entry_seolang_mova_widget_box_end'] = $this->language->get('entry_seolang_mova_widget_box_end');
		...
		public function autocookie() {
			...
			if (isset($this->request->get['filter_name'])) {
				...
				$cookie_auto = array('languageauto', 'language');
