...
class ControllerBlogArticle extends Controller {
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['image_short'])) {
            $data['image_short'] = $this->request->post['image_short'];
        } elseif (!empty($article_info)) {
            $data['image_short'] = $article_info['image_short'];
        } else {
            $data['image_short'] = '';
        }
        ...
        if (isset($this->request->post['image_short']) && is_file(DIR_IMAGE . $this->request->post['image_short'])) {
            $data['thumb_short'] = $this->model_tool_image->resize($this->request->post['image_short'], 100, 100);
        } elseif (!empty($article_info) && is_file(DIR_IMAGE . $article_info['image_short'])) {
            $data['thumb_short'] = $this->model_tool_image->resize($article_info['image_short'], 100, 100);
        } else {
            $data['thumb_short'] = $this->model_tool_image->resize('no_image.png', 100, 100);
        }
