...
$_['entry_date_modified'] = 'Дата обновления';
	$_['entry_receiver']='ФИО получателя';
	$_['entry_inn']='ИНН';
	$_['entry_iban']='IBAN';
	$_['text_receiver']='Реквизиты получателя';
...
$_['error_model']         = 'Код Товара должен содержать от 3 до 64 символов!';
	$_['error_receiver']='Получатель должен содержать от 1 до 32 символов';
	$_['error_iban']='Неправильный формат IBAN!: UA XX XXXXXX XXXXX XXXX XXXX XXXX XX';
	$_['error_inn']='Неправильный ИНН';