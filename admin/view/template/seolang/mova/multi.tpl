				...
				<tr>
					<td>
						...
						<div id="tabs-tab-multi-<?php echo $multi_name_row; ?>" class="htabs seolang-margin-top-6">
							<a href="#tab-multi-other-<?php echo $multi_name_row; ?>" class="lm-tab"><?php echo $entry_seolang_tab_other; ?></a>
							<a href="#tab-multi-html-<?php echo $multi_name_row; ?>" class="lm-tab"><?php echo $entry_seolang_html; ?></a>
							<a href="#tab-multi-scripts-<?php echo $multi_name_row; ?>" class="lm-tab"><?php echo $entry_seolang_scripts; ?></a>
						</div>
						...
						<div id="tab-multi-other-<?php echo $multi_name_row; ?>">
							...
							<div style="clear: both;" class="flex200">
								<div>
									...
									<div class="input-group">
										<select class="form-control" name="<?php echo $multi_name; ?>[langswitch_replace]">
							...
							<div style="clear: both;" class="flex200">
								<div>
									...
									<div class="input-group">
										<select class="form-control" name="<?php echo $multi_name; ?>[image_status]">
							...
							<div style="clear: both;" class="flex200">
								<div>
									...
									<div class="input-group">
										<select class="form-control" name="<?php echo $multi_name; ?>[autoredirect]">
							...
							<div style="clear: both;" class="flex200">
								<div>
									...
									<div class="input-group">
										<select class="form-control" name="<?php echo $multi_name; ?>[bots_status]">
							...
							<div style="clear: both;" class="flex200">
								<div>
									...
									<div class="input-group">
										<select class="form-control" name="<?php echo $multi_name; ?>[redirect]">
							...
							<div style="clear: both;" class="flex200">
								<div>
									...
									<div class="input-group">
										<select class="form-control" name="<?php echo $multi_name; ?>[ex_gets_status]">
						...
						<div id="tab-multi-html-<?php echo $multi_name_row; ?>">
							...
							<div class="seolang-margin-top-6" style="clear: both;">
								<div id="tabs-multi-<?php echo $multi_name_row; ?>" class="htabs">
									...
									?>
										<a href="#tab-lang-<?php echo $multi_name_row; ?>-<?php echo $lang['language_id']; ?>" class="lm-tab"><?php echo strtoupper($lang['code_short']); ?> <img src="<?php echo $lang['image']; ?>" title="<?php echo $lang['name']; ?>"></a>
									<?php } ?>
								</div>
								...
								?>
									<div id="tab-lang-<?php echo $multi_name_row; ?>-<?php echo $lang['language_id']; ?>">
										...
										<div class="seolang-margin-top-6">
											<?php echo $entry_seolang_mova_widget_box_begin; ?>
										</div>
										<div class="input-group">
											<span class="input-group-addon"><?php echo strtoupper($lang['code_short']); ?><br><img src="<?php echo $lang['image']; ?>" title="<?php echo $lang['name']; ?>"></span>
											<textarea class="form-control" cols="50" rows="3" name="<?php echo $multi_name; ?>[box_begin][<?php echo $lang['language_id']; ?>]"><?php if (isset($seolang_settings_store_widgets_data[$multi_name]['box_begin'][$lang['language_id']]) && $seolang_settings_store_widgets_data[$multi_name]['box_begin'][$lang['language_id']] != '') {
																																													echo $seolang_settings_store_widgets_data[$multi_name]['box_begin'][$lang['language_id']];
																																												} else {
																																													echo '';
																																												} ?></textarea>
										</div>
										...
										<div class="seolang-margin-top-6">
											<?php echo $entry_seolang_mova_widget_box_end; ?>
										</div>
										<div class="input-group">
											<span class="input-group-addon"><?php echo strtoupper($lang['code_short']); ?><br><img src="<?php echo $lang['image']; ?>" title="<?php echo $lang['name']; ?>"></span>
											<textarea class="form-control" cols="50" rows="3" name="<?php echo $multi_name; ?>[box_end][<?php echo $lang['language_id']; ?>]"><?php if (isset($seolang_settings_store_widgets_data[$multi_name]['box_end'][$lang['language_id']]) && $seolang_settings_store_widgets_data[$multi_name]['box_end'][$lang['language_id']] != '') {
																																													echo $seolang_settings_store_widgets_data[$multi_name]['box_end'][$lang['language_id']];
																																												} else {
																																													echo '';
																																												} ?></textarea>
										</div>
						...
						<div id="tab-multi-scripts-<?php echo $multi_name_row; ?>">
							...
							<div style="clear: both;">
								...
								<div class="input-group">
									<select class="form-control" name="<?php echo $multi_name; ?>[doc_ready]">
