						...
						<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
							...
							<div style="display: flex; align-items: center; margin-top: 4px; margin-bottom: 8px;">
								...
								<div class="input-group">
									<select class="form-control" name="seolang_langmark_settings[langmark_widget_status]">
							...
							<div id="tab-pagination">
								<table class="mynotable" style="margin-bottom:20px; background: white; vertical-align: center;">
									...
									<tr>
										...
										<td>
											<div class="input-group"><select class="form-control" name="asc_langmark_<?php echo $store_id ?>[pagination]">
									...
									<tr>
										...
										<td>
											<div class="input-group"><select class="form-control" name="asc_langmark_<?php echo $store_id ?>[seo_pagination]">
									...
									<?php if (SC_VERSION > 15) { ?>
										...
										<td>
											<div class="input-group"><select class="form-control" name="asc_langmark_<?php echo $store_id ?>[description_status]">
