               ...
               <div class="content">
                  ...
                  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                     <div style="display: flex; flex-wrap: wrap; align-content: space-between; justify-content: space-between; width: 100%; margin-top: 4px; margin-bottom: 8px;">
                        <div style="display: flex; align-items: center;">
                           ...
                           <div class="input-group">
                              <select class="form-control" name="seolang_settings[status]">
                     ...
                     <div id="tabs" class="htabs">
                        <a href="#tab-menu" class="lm-tab"><?php echo $tab_text_seolang_menu; ?></a>
                        <a href="#tab-main" class="lm-tab"><?php echo $tab_text_seolang_main; ?></a>
                        <a href="#tab-options" class="lm-tab"><?php echo $tab_text_seolang_options; ?></a>
                        <a href="#tab-install" class="lm-tab" id="tab-install-header"> <?php echo $entry_seolang_install_update; ?></a>
                        <a href="#tab-service" class="lm-tab"><?php echo $tab_text_seolang_service; ?></a>
                        <a href="#tab-doc" class="lm-tab"><?php echo $tab_text_seolang_doc; ?></a>
                     </div>
               ...
               <script>
                  $(document).ready(function() {
                     ...
                     $('.lm-tab').on('click', function() {
                        sh_tab_seolang_href = $(this).attr('href');
                        array_sh_tabs_click.push(sh_tab_seolang_href);
                        if (array_sh_tabs_click.length > 5) {
